...
import upkoding.unlucky13 as app
...
def test_app1():
    ...
    input_file = read_files('i/u13.in')
    output_file = read_files('o/u13.ou')
...
def test_app2():
    # 2 edit input and output files. set output in string
    # 3 change name files input and output. rec using abbrevation
    input_file = read_files('i/u131.in')
    output_file = read_files('o/u131.ou')
    my_app(input_file, output_file, app.main)
